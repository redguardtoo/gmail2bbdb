...
- Run command *"M-x gmail2bbdb-import-file"* and select contacts.vcf. $HOME/.bbdb.el will be created.
...
You can specify the email excluded patterns. Email address matching one of the patterns will NOT be excluded.
#+BEGIN_SRC elisp
